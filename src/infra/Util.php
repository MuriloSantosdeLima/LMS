<?php
class Util {
    public static function TemplateRender($url_render) {
        include_once('./src/view/template/header.php');
        include_once($url_render);
        include_once('./src/view/template/footer.php');
    }
